...
use Janisbiz\LightOrm\EntityInterface;
...
abstract class AbstractRepository
{
    ...
    public function insert(QueryBuilder $queryBuilder, $toString = false)
    {
        ...
        $pdoStatement = $connection->prepare($queryBuilder->buildQuery());
        $pdoStatement->execute($queryBuilder->bindValueData());
    ...
    public function findOne(QueryBuilder $queryBuilder, $toString = false)
    {
        ...
        $pdoStatement = $this->getConnection()->prepare($queryBuilder->buildQuery());
        $pdoStatement->execute($queryBuilder->bindData());
